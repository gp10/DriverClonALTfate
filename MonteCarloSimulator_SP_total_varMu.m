function [nx_basal,nx_total,ntime] = MonteCarloSimulator_SP_total_varMu(rtime,lambda,dens,r,gamma,micetime,mice_m_t,indiv,tlag,GamShape)
...
% tlag = 0.5/7;
% GamShape = 8;
% [nx_basal,nx_total,ntime] = MonteCarloSimulator_SP_total_varMu(rtime,lambda,dens,r,gamma,micetime,mice_m_t,indiv,tlag,GamShape);
