...
% clonesizes_ref: cell array or matrix of clone sizes {:,timepoints} used for cutoff1 (e.g. basal clone sizes)
% cutoff1: minimum clone size considered for the histogram (by default=0: all sizes considered)
% clonesizes_ref2: cell array or matrix of clone sizes {:,timepoints} used for additional cutoff2 (e.g. total clone sizes) (optional cutoff)
