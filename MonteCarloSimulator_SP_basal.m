function [nx_basal,ntime] = MonteCarloSimulator_SP_basal(rtime,lambda,r,gamma,indiv,tlag,GamShape)
...
% tlag = 0.5/7;
% GamShape = 8;
% [nx_basal,ntime] = MonteCarloSimulator_SP_basal(rtime,lambda,r,gamma,indiv,tlag,GamShape);
